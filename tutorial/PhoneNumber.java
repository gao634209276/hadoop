...
public class PhoneNumber extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PhoneNumber\",\"namespace\":\"com.example.tutorial\",\"fields\":[{\"name\":\"number\",\"type\":\"string\"},{\"name\":\"type\",\"type\":[\"int\",\"null\"]}]}");
  ...
  public static com.example.tutorial.PhoneNumber.Builder newBuilder() {
    return new com.example.tutorial.PhoneNumber.Builder();
  }
  
  /** Creates a new PhoneNumber RecordBuilder by copying an existing Builder */
  public static com.example.tutorial.PhoneNumber.Builder newBuilder(com.example.tutorial.PhoneNumber.Builder other) {
    return new com.example.tutorial.PhoneNumber.Builder(other);
  }
  
  /** Creates a new PhoneNumber RecordBuilder by copying an existing PhoneNumber instance */
  public static com.example.tutorial.PhoneNumber.Builder newBuilder(com.example.tutorial.PhoneNumber other) {
    return new com.example.tutorial.PhoneNumber.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PhoneNumber>
    ...
    private Builder() {
      super(com.example.tutorial.PhoneNumber.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.example.tutorial.PhoneNumber.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing PhoneNumber instance */
    private Builder(com.example.tutorial.PhoneNumber other) {
            super(com.example.tutorial.PhoneNumber.SCHEMA$);
    ...
    /** Sets the value of the 'number' field */
    public com.example.tutorial.PhoneNumber.Builder setNumber(java.lang.CharSequence value) {
    ...
    public com.example.tutorial.PhoneNumber.Builder clearNumber() {
      number = null;
    ...
    /** Sets the value of the 'type' field */
    public com.example.tutorial.PhoneNumber.Builder setType(java.lang.Integer value) {
    ...
    public com.example.tutorial.PhoneNumber.Builder clearType() {
      type = null;
